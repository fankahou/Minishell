...
/*   Updated: 2025/04/05 12:15:51 by kfan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//-----important: conditions: only applies if it's the first char is valid or not inside "" quote
...
//to check char by char and only joining the new char if it is not an extra space 
...
//if quote > 2 means it is a quote within a quote, which the quote will be copied eg. "'$USER'" or '"$USER"'
//if space <2 
// wild_switch == 0; jackpot not hit, you only have one chance to verifly after you hit it
